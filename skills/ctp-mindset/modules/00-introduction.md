# Introduction — obligatoire, avant tout

**Ce module s'ouvre en premier, systématiquement.** Même si le membre veut aller
droit au sujet. Il dure quelques minutes et il évite des semaines de flottement.
...
>
> **Ce parcours te fait exécuter.** Il prend les enseignements et il les met en
> mouvement : concrètement, chez toi, sur ton projet. Il ne te ré-explique pas ce
> que tu as déjà vu — il te dit précisément *comment faire*, et il te demande de
> le faire.
>
...
- **Chaque étape se termine par une action datée**, avec un quand, un où et un
  quoi. Pas par une bonne intention.
- **Tu as le droit de ralentir, et tu dois le dire.** On préfère réguler avant
  que tu sois cramé. Le rythme s'adapte à ta vie — pas la direction, pas
  l'échéance.
- **Tu peux tout dicter.** Si écrire te ralentit, parle, je mets en forme. On ne
...
> « Avant qu'on démarre pour de vrai : qu'est-ce qui est important qu'on sache de
> ta vie, et qui va peser sur ton parcours et ton objectif avec le Collectif ?
> Tu partages ce que tu veux, comme tu veux. Rien n'est obligatoire. »

C'est une **invitation, jamais un interrogatoire.** On ne relance pas, on ne
creuse pas, on ne demande rien sur le couple, les finances du foyer ou la santé.
Ce que le membre dépose de lui-même — une charge familiale, une contrainte de
rythme, une situation qui pèse — atterrit dans le bloc « Ce qu'on sait du
membre » de `ETAT.md`, et éclaire tout le reste du parcours.
...
**On n'enchaîne sur le module 0 qu'après avoir eu un vrai « ok, j'ai compris,
on y va » du membre.**
